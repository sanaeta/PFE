  ...
  @override Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(child: SingleChildScrollView(padding: const EdgeInsets.all(20), child: Column(children: [
        ...
        DropdownButtonFormField<String>(decoration: AppTheme.inputDecoration("Choisir votre filière", Icons.school_outlined), initialValue: _selectedFiliereId, items: _listeFilieres.map((f) => DropdownMenuItem<String>(value: f['id'].toString(), child: Text(f['nom']))).toList(), onChanged: (v) => setState(() => _selectedFiliereId = v)),
